...
import { AddIcon, AutoRenewIcon, KtbstIcon } from "../Svg";
  ...
  return (
    <Box width="640px">
      <BrowserRouter>
        ...
        <Row>
          <Button startIcon={<KtbstIcon />}>Start Icon</Button>
          <Button endIcon={<KtbstIcon />}>End Icon</Button>
          <Button startIcon={<KtbstIcon />} endIcon={<KtbstIcon />}>
            Start & End Icon
          </Button>
        </Row>
        <Row>
